...
public class GameGrain : Grain, IGameGrain
{
    ...
    //
    // Ctor
    public GameGrain(IHubContext<GameHub, IGameHub> gameHubContext, IDeck deck)
    {
    ...
    private async Task SetupRound(GameRound round)
    {
        ...
        await _gameHub
            .Clients
            .All
            .GameStarted(_discardPile, _availableCards);
    }
    ...
    {            
        ...
        if(!winningTurn && _roundResults.TryGetValue(_currentRound, out var currentRoundResult))
        {
    ...
    {
        return playerId == _playerIds[_indexNextPlayerToMove];
    }
